...
import edu.usf.micronsl.port.onedimensional.concat.Int1dPortConcatenate;
 ...
 * 
 */
public class Int1dConcatModule extends Module {
	 ...
	 */
	public Int1dConcatModule(String name) {
		super(name);
	}
	...
	public void addInPorts(List<Port> ports) {
		...
		addOutPort("jointState", new Int1dPortConcatenate(this,
				(List<Int1dPort>) (List<?>) ports));
	}

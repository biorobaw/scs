...
public class AddSmallWallsTask extends Task {
	...
	public void perform(Experiment experiment) {
		...
		while (!addWalls(experiment.getUniverse(), experiment.getSubject()))
			;
	...
	public void perform(Trial trial) {
		System.out.println("[+] Adding wmall walls");
		while (!addWalls(trial.getUniverse(), trial.getSubject()))
			;
		System.out.println("[+] Small walls added");
	}
	...
	public void perform(Episode episode) {
		System.out.println("[+] Adding wmall walls");
		while (!addWalls(episode.getUniverse(), episode.getSubject()))
			;
		System.out.println("[+] Small walls added");
	}
	...
	public boolean addWalls(Universe univ, Subject sub) {

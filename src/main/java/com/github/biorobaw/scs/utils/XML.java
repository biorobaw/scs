...
public class XML  {
	...
	public <T> List<T> getListAttr(String name, TypeParser<T> c){
	...
	public List<String> getStringListAttr(String name) {
		return getListAttr(name, x -> x);
	}
	public List<Integer> getIntListAttribute(String name) {
		return getListAttr(name, Integer::parseInt);
	}

	public List<Float> getFloatListAttribute(String name) {
		return getListAttr(name, Float::parseFloat);
	}

	public float[] getFloatArrayAttribute(String name) {
		List<Float> list = getFloatListAttribute(name);

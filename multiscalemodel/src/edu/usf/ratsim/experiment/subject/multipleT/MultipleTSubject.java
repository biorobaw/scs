...
//				System.out.println("Replay event " + r);
		...
		// Float1dSparsePortMap pcs =
		// (Float1dSparsePortMap)awake.placeCells.getOutPort("activation");
...
//
//			if ((e - noFoodLaps) % (cantReplay + 1) == 0) {// do 1 awake 10
//															// asleep
//				setAwake();
//
//			} else {

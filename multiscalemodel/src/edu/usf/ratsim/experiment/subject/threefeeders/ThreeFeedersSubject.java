...
public class ThreeFeedersSubject extends SubjectOld {

	private float step;
	private float leftAngle;
	private float rightAngle;
	
	private ThreeFeedersModel model;

	public ThreeFeedersSubject(String name, String group,
		...
		model = new ThreeFeedersModel(params, this, lRobot);
	}
